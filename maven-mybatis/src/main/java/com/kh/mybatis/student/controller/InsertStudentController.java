...
public class InsertStudentController extends AbstractController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("doGet@InsertStudentController");
	...
	public String doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("doPost@InsertStudentController");
		...
		try {
			...
			//System.out.println("result@InsertStudentController = " + result);
			
			//3. 사용자피드백 및 리다이렉트
			HttpSession session = request.getSession();
			session.setAttribute("msg", "학생등록 성공!");
