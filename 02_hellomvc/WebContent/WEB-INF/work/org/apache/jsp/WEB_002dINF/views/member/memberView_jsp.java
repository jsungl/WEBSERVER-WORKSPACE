 ...
 * Generated at: 2021-03-29 16:54:49 UTC
...
public final class memberView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1617036744578L));
 ...
 if(loginMember == null) { 
	...
	if(hobby != null){
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<form name=\"deleteMemberFrm\">\r\n");
      ...
      out.write("\t\tif(/^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i.test($email.val()) == false){\r\n");
      out.write("\t\t\talert(\"유효한 이메일이 아닙니다.\");\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$frm = $(document.deleteMemberFrm); \r\n");
      out.write("\t\t$frm.attr(\"action\", \"");
      out.print( request.getContextPath() );
