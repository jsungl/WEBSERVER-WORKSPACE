 ...
 * Generated at: 2021-04-08 12:23:15 UTC
...
public final class boardView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginMember == null){ 
      ...
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("//document가 아니고 부모여도 상관없음\r\n");
      out.write("//name=boardCommentFrm이 submit이벤트가 발생하면 아래 function실행\r\n");
 ...
 if(loginMember == null){ 
      ...
      out.write("\t\r\n");
      out.write("\t//댓글내용\r\n");
      out.write("\tvar $content = $(\"[name=content]\",e.target); //e.target하위에 있는 name=content를 찾는다\r\n");
